          ...
          b-col(md='8')
            ...
            b-card-text.ml-3
              ul
                ...
                li 建議將鮮花放入花瓶或長型的玻璃杯中，不要將花悶在包裝紙內。
                li 請每天換水，保持水質的乾淨，清洗花莖，否則在環境下花莖容易腐爛，使得花朵容易凋零。
          ...
          b-col(md='8')
              ...
              b-card-text.ml-3
                ul
                  li 澆水是存活關鍵：
                    ul
                      li 春季：3 ~5天一次，每次約100~150cc即可。
                      li 夏季：忌白天澆水，水珠停留會造成聚光效應灼傷葉子，1~2天澆一次，每次約200~300cc。
                      li 秋季：2~4天澆一次，每次約150~250cc即可。
          ...
          b-col(md='8')
              ...
              b-card-text.ml-3
                ul
                  ...
                  li 建議不要拆除包裝，維持原樣貌即可。
                  li 若有灰塵，可用刷具或吹風機微風吹拂，妥善保存約可維持 1 - 3 年不等。
                  li 如遇潮濕花材產生變化，可試著在除溼環境下獲部分改善。
</template>
